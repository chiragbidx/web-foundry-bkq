...
## First Request Rule
- Ship the first feature/update directly in `app/page.tsx` before adding new routes or structure.
- Build the requested feature end to end first (functionality, UX, and data flow if any), then rebrand the entire page — header, hero, body, and footer — to match the feature.
- Branding and content polish come after the feature works; prioritize feature delivery over visuals.
